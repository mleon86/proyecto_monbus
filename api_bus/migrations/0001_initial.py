...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('viaje_inicio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='viaje_inicio_bus_datos_update', serialize=False, to='api_bus.Viaje_Incio')),
